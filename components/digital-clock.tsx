...
export default function DigitalClock() {
  ...
  return (
    <div className="flex items-center bg-slate-700 justify-center h-screen">
      <Card className="p-8 shadow-lg bg-slate-500 [box-shadow:0px_0px_20px_black] rounded-2xl">
